<template>
  <!-- Inline SVG icon set. Extend as needed. -->
  <svg
    v-if="svgPath"
    :class="props.class"
    fill="none"
...
const props = withDefaults(defineProps<Props>(), { class: 'w-5 h-5' })
...
const icons: Record<string, string> = {
  ...
  'file-bar-chart': '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/>',
  ...
  download: '<polyline points="8 17 12 21 16 17"/><line x1="12" y1="12" x2="12" y2="21"/><path d="M20.88 18.09A5 5 0 0018 9h-1.26A8 8 0 104 16.29"/>',
...
const svgPath = computed(() => icons[props.name] ?? icons['grid'])
</script>
