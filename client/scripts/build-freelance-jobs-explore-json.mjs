/**
 * One-off generator: writes src/constants/freelance-jobs.explore-directory.json
 * Run: node scripts/build-freelance-jobs-explore-json.mjs
 */
...
const DATA = {
  ...
  N: ['Narrator', 'NopCommerce Developer', 'Non-Fiction Writer'],
  O: [
    'Oberlo Freelancer',
  ...
  Q: ['Quality Control Freelancer', 'Qt Developer', 'QuickBooks Consultant'],
  R: [
  ...
  X: ['Xamarin Specialist', 'Xero Specialist', 'Xactimate Specialist'],
  Y: ['YouTube Freelancer', 'YouTube API Developer'],
  Z: ['Zoom Video Conferencing Specialist', 'Zapier Developer'],
}

const outPath = path.join(__dirname, '..', 'src', 'constants', 'freelance-jobs.explore-directory.json')
