...
async function main() {
  ...
  await prisma.freelancerProfile.upsert({
    ...
    create: {
      ...
      skills: JSON.stringify(['React', 'TypeScript', 'Node.js', 'PostgreSQL', 'AWS', 'Docker', 'GraphQL']),
      ...
      languages: JSON.stringify([{ language: 'English', proficiency: 'native' }, { language: 'Spanish', proficiency: 'fluent' }]),
  ...
  await prisma.freelancerProfile.upsert({
    ...
    create: {
      ...
      hourlyRate: 75,
      availability: 'available',
      skills: JSON.stringify(['Figma', 'Adobe XD', 'UI Design', 'UX Research', 'Prototyping', 'Brand Design']),
      categories: JSON.stringify(['design-creative', 'web-development']),
      languages: JSON.stringify([{ language: 'English', proficiency: 'native' }]),
      totalEarnings: 89000,
      completedJobs: 35,
      successRate: 97,
      rating: 4.8,
  ...
  await prisma.freelancerProfile.upsert({
    ...
    create: {
      ...
      hourlyRate: 70,
      availability: 'busy',
      skills: JSON.stringify(['React Native', 'Flutter', 'Swift', 'Kotlin', 'Firebase', 'TypeScript']),
      categories: JSON.stringify(['mobile-development']),
      languages: JSON.stringify([{ language: 'English', proficiency: 'fluent' }, { language: 'Korean', proficiency: 'native' }]),
      totalEarnings: 67000,
      completedJobs: 28,
      successRate: 96,
      rating: 4.7,
  ...
  const job1 = await prisma.job.upsert({
    ...
    create: {
      ...
      skills: JSON.stringify(['React', 'TypeScript', 'Tailwind CSS', 'Chart.js', 'REST API']),
      budgetType: 'fixed',
      budgetFixed: 5000,
      duration: '1-3 months',
  ...
  const job2 = await prisma.job.upsert({
    ...
    create: {
      ...
      skills: JSON.stringify(['React Native', 'TypeScript', 'Firebase', 'Stripe', 'Maps API']),
      budgetType: 'hourly',
      budgetMin: 50,
      budgetMax: 80,
      duration: '3-6 months',
  ...
  const job3 = await prisma.job.upsert({
    ...
    create: {
      ...
      skills: JSON.stringify(['Figma', 'Brand Design', 'UI Design', 'Logo Design', 'Design Systems']),
      budgetType: 'fixed',
      budgetFixed: 3000,
      duration: '1-3 months',
      experienceLevel: 'expert',
  ...
  const job4 = await prisma.job.upsert({
    ...
    create: {
      ...
      category: 'web-development',
      skills: JSON.stringify(['WordPress', 'WooCommerce', 'PHP', 'CSS', 'Payment Integration']),
      budgetType: 'fixed',
      budgetFixed: 1500,
  ...
  const job5 = await prisma.job.upsert({
    ...
    create: {
      ...
      category: 'web-development',
      subcategory: 'backend',
      skills: JSON.stringify(['Node.js', 'Express', 'PostgreSQL', 'Stripe API', 'REST API', 'Docker']),
      budgetType: 'hourly',
      budgetMin: 60,
      budgetMax: 100,
      duration: '1-3 months',
    ...
    data: [
      {
        ...
        skills: JSON.stringify({ communication: 5, quality: 5, expertise: 5, professionalism: 5, hireAgain: 5 }),
      },
    ],
  });
